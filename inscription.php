...
<form id="formID" class="formular" method="post" action="validformulaire.php">
	...
	<div class="infos">En cochant la case ci-dessous, vous acceptez <a id="agreeReglement">les règlements de la HeHLan </a></div>
		  <div id="tabsReglement" class="reglements" style="margin-left: -90px">
		    <ul>
		      <li><a href="#charte"><span>Charte HEHLan 2015</span></a></li>
		    ...
		    <div id="charte">
			  ...
			  <iframe width="650px" height="800px" src="reglements/charte.pdf"></iframe>
		      </div>-->
		    ...
		    <div id="lol">
			  ...
			  <?php require_once("textesHTML/ReglementLOL.html"); ?>
		    </div>
		    <div id="cod">
		      <!--<div class="media" style="width: 670px; margin: 0 auto;">
			  <iframe width="650px" height="800px" src="reglements/ReglesCOD.pdf"></iframe>
		      </div>-->
			  <?php require_once("textesHTML/ReglementCOD.html"); ?>
		    </div>
		    <div id="hs">
		      <!--<div class="media" style="width: 670px; margin: 0 auto;">
			  <iframe width="650px" height="800px" src="reglements/ReglesHS.pdf"></iframe>
		      </div>-->
			  <?php require_once("textesHTML/ReglementHS.html"); ?>
		    </div>
		    <div id="tmn">
		      <!--<div class="media" style="width: 670px; margin: 0 auto;">
			  <iframe width="650px" height="800px" src="reglements/ReglesTMN.pdf"></iframe>
		      </div>-->
			  <?php require_once("textesHTML/ReglementTMN.html"); ?>
		    </div>
		  </div>
	<br>
