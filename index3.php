...
<body style="background-color: #000;">
	...
	<div id="top">
 	...
 	<div id="content">
        ...
        <div id="bloc1">
            <div id="bloc1-left" style="background: none; ">
                <?php
		//nombre d'inscrits
		...
		//nombre de joueurs qui ont paye
		...
		?>
		<div style="background:rgba(15,37,68,0.7);  width: 330px; height: 300px; font-size: 15px; padding-left: 15px;">
		    <br>
		    <p style="font-size: 25px;text-align: center; margin-left: -15px;" >
		    <strong style="color: #57BADA; " ><?php echo $nbrInscrit;?></strong> joueurs inscrits sur le site<br>
		    <br>dont <strong style="color: #57BADA;"><?php echo $nbrPaye;?></strong> joueurs ont payé
		    </p>
		    <br><br>
		    Attention, il reste <strong style="color: #57BADA;"><?php echo (120-$nbrPaye);?></strong> places disponibles<br><br>
		    Rappel : Seuls les joueurs qui ont payé, sont officiellement inscrits à la HeHLan 2014
